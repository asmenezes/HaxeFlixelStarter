...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_music_mandatoryovertime_mp3 extends null { }
...
@:keep @:file("assets/music/MandatoryOvertime.mp3") @:noCompletion #if display private #end class __ASSET__assets_music_mandatoryovertime_mp3 extends haxe.io.Bytes {}
